# eval_caedqn.py – evaluate trained CAE-DQN on 6x6 with 4 mines across multiple seeds
import sys
import os
...
ALGORITHM_NAME = "CAE-DQN"
OUTPUT_CSV = "csv/eval_caedqn_4mines.csv"
...
class EvalAgent:
    ...
    def get_action(self, state):
        ...
        # CAE model outputs [q_values, embedding]; q_values shape: (batch, num_actions)
...
def main():
    ...
    pbar = tqdm(total=total_episodes, desc="Evaluating CAE-DQN", unit="ep")
